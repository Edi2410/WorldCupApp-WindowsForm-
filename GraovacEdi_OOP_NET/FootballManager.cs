...
namespace GraovacEdi_OOP_NET
{
    public partial class FootballManager : Form
    {
        ...
        private void FootballManager_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (MessageBox.Show("Jeste li sigurni da želite zatvoriti aplikaciju?", "Potvrda zatvaranja",
